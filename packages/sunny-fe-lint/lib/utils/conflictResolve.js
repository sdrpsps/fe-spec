    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                logs_1.default.warn("\u68C0\u6D4B\u5230\u9879\u76EE\u4E2D\u5B58\u5728\u53EF\u80FD\u4E0E ".concat(constants_1.PACKAGE_NAME, " \u51B2\u7A81\u7684\u4F9D\u8D56\u548C\u914D\u7F6E\uFF0C\u4E3A\u4FDD\u8BC1\u6B63\u5E38\u8FD0\u884C\u5C06"));
                if (willRemovePackage.length > 0) {
                    logs_1.default.warn('删除以下依赖：');
                    logs_1.default.warn(JSON.stringify(willRemovePackage, null, 2));
                }
                if (uselessConfig.length > 0) {
                    logs_1.default.warn('删除以下配置文件：');
                    logs_1.default.warn(JSON.stringify(uselessConfig, null, 2));
                }
                if (reWriteConfig.length > 0) {
                    logs_1.default.warn('覆盖以下配置文件：');
                    logs_1.default.warn(JSON.stringify(reWriteConfig, null, 2));
                }
